...
const TYPE_COLORS: Record<EntityType, string> = {
  ...
  leads: "bg-amber-100 text-amber-700 border-amber-200",
  talents: "bg-green-100 text-green-700 border-green-200",
  opensource: "bg-cyan-100 text-cyan-700 border-cyan-200",
  news: "bg-orange-100 text-orange-700 border-orange-200",
  jobs: "bg-slate-100 text-slate-700 border-slate-200",
  products: "bg-pink-100 text-pink-700 border-pink-200",
