          ...
          <table className="w-full text-[13px]">
            <thead>
              <tr className="border-b border-line bg-paper/30 text-left">
                ...
                <th className="hidden lg:table-cell px-5 py-3 font-mono text-[10px] uppercase tracking-[0.18em] text-ink-500">{t.list.source}</th>
                ...
                <th className="hidden lg:table-cell px-5 py-3 font-mono text-[10px] uppercase tracking-[0.18em] text-ink-500">{t.common.topics}</th>
                <th className="hidden lg:table-cell px-5 py-3 font-mono text-[10px] uppercase tracking-[0.18em] text-ink-500">{t.list.linkedin}</th>
              ...
              {talents.length === 0 ? (
                ...
                talents.map((tl) => (
                  <tr key={tl.id} className="hover:bg-paper/40 transition-colors">
                    ...
                    <td className="hidden lg:table-cell px-5 py-3 text-ink-600 text-[12px]">{tl.source ?? "—"}</td>
                    <td className="px-5 py-3">
                    ...
                    <td className="hidden lg:table-cell px-5 py-3"><FavoriteButton entity="talents" id={tl.id} label={tl.name} /></td>
                  </tr>
                ))
              )}
            </tbody>
