  ...
  return (
    <DetailModal title={product.name} label={t.nav.products} onClose={onClose}>
      ...
      <dl className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-[13px]">
        ...
        <div><dt className="font-mono text-[10px] uppercase tracking-[0.18em] text-ink-500">{t.product.pricing}</dt><dd className="mt-1 text-ink-800">{t.product[product.pricing]}</dd></div>
